...
class FontUtil {
  ...
  static TextStyle habbitTitleFont = defaultFont.copyWith(
    color: ColorUtil.habbitTextColor,
    fontWeight: FontWeight.w500,
    fontSize: 18,
  );
  static TextStyle habbitGoalFont = defaultFont.copyWith(
    color: ColorUtil.habbitTextColor.withOpacity(0.8),
    fontWeight: FontWeight.w300,
    fontSize: 12,
  );
  static TextStyle habbitProgressFont = defaultFont.copyWith(
    color: ColorUtil.habbitTextColor,
    fontWeight: FontWeight.w500,
    fontSize: 12,
  );
